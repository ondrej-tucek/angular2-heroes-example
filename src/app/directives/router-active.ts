...
/**
 * RouterActiveDirective dynamically finds the first element with routerLink
 * and toggles the active class
 *
 * ## Use
 *
 * ```
 ...
 */
@Directive({
  selector: '[router-active]'  // tslint:disable-line
})
export class RouterActiveDirective implements OnInit {
  ...
  constructor(
    ...
    @Optional() @Attribute('router-active') routerActiveAttr?: string) {  // tslint:disable-line
